...
const Soluciones1 = () => {
  ...
  return (
    <section className="relative min-h-screen flex items-center overflow-hidden font-sans bg-gradient-to-br from-white to-blue-100">
      <div className="container mx-auto px-4 relative z-10 transition-transform duration-300 ease-in-out hover:scale-105">
        <div className="grid lg:grid-cols-1 gap-12 items-center min-h-screen">
          ...
          <div className="text-gray-800 text-center">
            <h1 className="text-4xl lg:text-5xl xl:text-6xl font-extrabold leading-tight mb-6 animate-fade-in-up bg-gradient-to-r from-blue-900 to-blue-600 text-transparent bg-clip-text">
